...
# scan_l = Scan(scan_name="scan_2334_filt")
# scan_l.import_points_from_file(file_path="data/8_floors_wall/scan_2334_filt.txt")

scan_r = Scan(scan_name="scan_2336_filt")
scan_r.import_points_from_file(file_path="data/8_floors_wall/scan_2336_filt.txt")

scan_trasformed = transform_lsm.transform_scan(scan_r)
scan_trasformed.export_points_from_file(f"{scan_trasformed.name}_transformed.txt")